package newGui.pages.login.component.main;

import newGui.util.Constants;
import newGui.util.http.HttpClientUtil;
...
public class LoginController {
    ...
    @FXML private dashboardController SEmulatorDashboardController;
