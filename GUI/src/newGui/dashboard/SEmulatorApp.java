...
public class SEmulatorApp extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        final String LAYOUT_FXML_PATH = "/newGui/dashboard/component/primary/dashboard.fxml";
...
//        controller.setEngine(engine);
    ...
    private void loadStyles(Scene scene){
        final String STYLES_CSS_PATH = "/newGui/dashboard/styles.css";
